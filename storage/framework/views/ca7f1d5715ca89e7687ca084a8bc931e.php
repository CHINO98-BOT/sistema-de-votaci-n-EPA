...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="<?php echo e(route('jurados.index')); ?>" class="nav-link">Jurados</a>
            </li>
        </ul>
    </nav>
        ...
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('jurados.index')); ?>" class="nav-link">
...
</html><?php /**PATH C:\xampp\htdocs\votacion-EPA\resources\views/jurados/layout.blade.php ENDPATH**/ ?>